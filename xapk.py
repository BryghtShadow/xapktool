...
class XAPK:
    ...
    def make_manifest(self):
        ...
        if obb_size:
            main_obb = {}
            main_obb['file'] = 'Android/obb/{package_name}/main.{version_code}.{package_name}.obb'.format(**manifest)
            main_obb['install_location'] = 'EXTERNAL_STORAGE'
            main_obb['install_path'] = 'Android/obb/{package_name}/main.{version_code}.{package_name}.obb'.format(**manifest)
